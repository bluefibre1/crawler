...
const WeaponTemplate& WeaponTemplates::SWORD() { static WeaponTemplate w(100, "Sword", 3, 7, Colors::GREEN(), '|', '-'); return w; }
const WeaponTemplate& WeaponTemplates::PUNCH() { static WeaponTemplate w(100, "Sword", 3, 7, Colors::GREEN(), '.', '.'); return w; }
